...
public class ManagerUpdateProfileTest {


	EditManagerProfileErrorMsgs acmerror;
	EditManagerProfileModel req = new EditManagerProfileModel();
	    
	    @Before
		public void setUpBeforeClass() throws Exception {
	    	acmerror = new EditManagerProfileErrorMsgs();
