...
public class CancelRentalSelenium extends functions.mavmiles_BusinessFunctions{
...
//    baseUrl = "http://localhost:8080/";
  ...
  @Test
  @FileParameters("src/selenium/inputs_CancelRentalSelenium.csv")
  public void testCancelRental(int testcaseno, String rentalid, String rentalid_valid, String errorMsg, String rentalidError, String comments) throws Exception {
//    driver.get(baseUrl + "/mavmiles/");
	  driver.get(sAppURL);
	  
	  Mav_BF_Login(driver, "karthik10", "Karthik@10") ;

	  driver.findElement(By.linkText("Cancel Reserved Rentals")).click();
//	  driver.findElement(By.xpath("//li[3]/a/span")).click();
	  
	  Mav_CancelRental(driver, rentalid);
	  ...
	  Mav_CancelRental(driver, rentalid_valid);
	  Thread.sleep(5_000);
