...
public class ManagerProfileEditSelenium extends functions.mavmiles_BusinessFunctions{
...
//    baseUrl = "http://localhost:8080/";
  ...
  @FileParameters("src/selenium/inputs_AdminProfileEdit.csv")
	public void testManagerProfileEdit(int testcaseno, String name, String loginid, String password, String Email,
			String Drivinglicense, String dlexp, String contact, String name_valid, String loginid_valid,
			String password_valid, String email_valid, String dl_valid, String dlexp_valid, String contact_valid,
...
//	  Mav_Login_Profile(driver,"karthik10");
	  User_Mav_Update_Profile(driver, name, password, Email, Drivinglicense, dlexp, contact);
//	  Thread.sleep(2_000);
...
//	  String UI_loginidError = driver.findElement(By.name("loginIDError")).getAttribute("value");
	  ...
	  String UI_Drivinglicenseerror = driver.findElement(By.name("dl_numberError")).getAttribute("value");
	  String UI_dlexperror = driver.findElement(By.name("dl_expiryError")).getAttribute("value");
	  String UI_contacterror = driver.findElement(By.name("phoneError")).getAttribute("value");
...
//	  assertEquals(loginidError, UI_loginidError);
	  ...
	  User_Mav_Update_Profile(driver, name_valid,  password_valid, email_valid, dl_valid, dlexp_valid, contact_valid);
