 ...
 */
@WebServlet("/CancelRentalModel")
public class CancelRentalModel extends HttpServlet {
//	CancelRentalDAO cdao = new CancelRentalDAO();
	...
	public void validateCancelRental(CancelRentalModel cancelmodel, CancelRentalErrorMsgs RerrorMsgs) {
		RerrorMsgs.setrentalidError(validaterentalid(cancelmodel.getrentalid()));
		RerrorMsgs.setErrorMsg();
	}

	public String validaterentalid(String rentalid3) {
		CancelRentalDAO cdao = new CancelRentalDAO();
		String result="";
		if (rentalid3.equals("")) {
			...
			if (cdao.RentalIDvalid(rentalid3)) {
