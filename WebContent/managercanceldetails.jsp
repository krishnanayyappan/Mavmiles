...
<title>Reservation Details - Manager</title>
</head>
<body>
...
<div class="main">
	...
	<h4>Reservation Details - Manager</h4>
	<form name="RentalForm" action="CancelManagerRental" method="post">
		<table>
			<tbody>
				<tr>
		...
		<input type="submit" value="Delete This Reservation" name="cancel" style="margin-left: 70px; width: 200px"/>
	</form>
