...
<body>
	...
	<form name="RentalForm" action="ManagerCancelRental" method="post">
	<input name="errMsg"  value="${MerrorMsgs.errorMsg}" type="text"  style ="background-color: white; color: red; border: none; width:500px" disabled="disabled">
		<table>
			<tbody>
				<tr>
					<td>Rental ID</td>
					<td><input id ="rentalid" type="text" name="rentalid" value="" size="30"/></td>
					<td> <input id = "rentalidError" name="rentalidError"  value="${MerrorMsgs.rentalidError}" type="text"  style ="background-color: white; color: red; border: none; width: 500px"   disabled="disabled" maxlength="60"> </td>
				</tr>
			</tbody>
		</table>
		<br>
