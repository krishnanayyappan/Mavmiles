...
<body>
	...
	<h4>Cars- Search</h4>
	<form name="AvailableCarsForm" action="calendar" method="post">
		<table>
			<tbody>
				<tr>
					<td style="max-width: 50px;">Start Date</td>
					<td><input id="startdate" type="text" name="startdate" value="${VACModel.startdate}" size="30"
						placeholder="YYYY-MM-DD" /></td>
						<td> <input id="startdateError" name="startdateError"  value="${verrorMsgs.startdateError}" type="text"  style ="background-color: white; color: red; border: none; width: 800px"   disabled="disabled" maxlength="60"> </td>
				</tr>
				
				<tr>
					<td>End Date</td>
					<td><input id="enddate" type="text" name="enddate" value="${VACModel.enddate}" size="30"
						placeholder="YYYY-MM-DD" /></td>
						<td> <input id="enddateError" name="enddateError"  value="${verrorMsgs.enddateError}" type="text"  style ="background-color: white; color: red; border: none; width: 800px"   disabled="disabled" maxlength="60"> </td>
				</tr>
		...
		<input type="submit" value="Submit" name="submit" style="width: 94px;" />
	</form>
